...
public enum Month {
    JAN("January", 31), FEB("February", 28), MAR("March", 31), APR("April", 30), MAY("May", 31), JUN("June", 30), JUL("July", 31), AUG("August", 31), SEP("September", 30), OKT("Oktober", 31), NOV("November", 30), DEC("December", 31);
    ...
    public Month plusMonth(Month month, int quantity){
        ...
        int res = index % months.length; // 13 % 12 = 1. 7 % 12 = ?
