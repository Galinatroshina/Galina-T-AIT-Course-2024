package classwork_35.ait.test;

import classwork_35.ait.dao.Album;
import classwork_35.ait.dao.AlbumImpl;
...
class AlbumImplTest {
    ...
    void setUp() {
        ...
        photos = new Photo[6];
        photos[0] = new Photo(1,1,"t1","url1",now.minusDays(10)); //фото сделанное 7 дней назад от сейчас
        ...
        for (int i = 0; i < 6; i++) {
            album.addPhoto(photos[i]); //добавили все фото в альбом
        }
    }
