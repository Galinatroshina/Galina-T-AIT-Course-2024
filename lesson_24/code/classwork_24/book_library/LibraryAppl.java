...
public class LibraryAppl {
    ...
    public static void main(String[] args) {
        ...
        Library library = new Library(6); //колличество для книг, может быть больше, но указываем пока на размер массива
        ...
        library.addBook(newBook); //добавили книгу в библиотеку
        System.out.println("----------------------");
